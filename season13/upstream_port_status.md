...
- [ ] **51ef854** - Merge pull request #766 (update/late-april-2026)
- [ ] **10b492e** - Crafting: extend generic crafting unid bases to all crafting filters
- [!] **9bac79c** - ci: build filters (version 61) (Ignored: Upstream CI specific)
- [ ] **5f7746d** - Vanilla+: enable formatted charms, mag/rare names, and ID'd mag/rare tooltips
- [!] **cbb9dac** - ci: build filters (version 62) (Ignored: Upstream CI specific)
- [ ] **43da270** - Merge pull request #767 (update/late-april-2026)
